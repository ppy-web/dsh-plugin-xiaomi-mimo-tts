...
export const zh = {
  ...
  'settings.enabledOnLabel': '鲸鱼娘开麦啦',
  'settings.enabledOffLabel': '鲸鱼娘休息中',
  ...
  'settings.autoPlayOnLabel': '我来主动念给你听',
  'settings.autoPlayOffLabel': '等你叫我再念',
  'settings.autoPlayHint': '浏览器可能会拒绝自动播放。',
  'settings.detailedVoiceConfig': '更多语音设置',
  ...
  'settings.localSpeechFirstHint': '优先使用浏览器本地语音朗读，失败时尝试使用 MiMo 音色。',
  'settings.localSpeechDisabledHint': '仅使用 MiMo 音色，失败时不会切换到本地语音。',
  ...
  'settings.formatPcmHint': '边生成边播放，支持暂停和继续；首个音频分片前失败时自动回退 MP3。',
  'settings.formatMp3Hint': '完整生成后播放，文件更小；支持暂停和继续。',
  'settings.formatWavHint': '完整生成后播放，保留无损音频但文件更大；支持暂停和继续。',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  'error.localNotAllowed': 'The browser blocked local speech. Click Read aloud to try again.',
  'error.localVoiceUnavailable': 'The selected browser voice is unavailable. Choose another voice.',
  'error.localTimeout': 'Browser speech did not respond within 2 minutes, so this playback was stopped.',
  'error.localAudioDevice': 'The local audio device reported an error. Check your system sound settings.',
  ...
  'settings.enabledHint': 'Disabling it hides voice settings and turns off automatic playback.',
  ...
  'settings.detailedVoiceConfig': 'More voice settings',
  'settings.stateOn': 'On',
  ...
  'settings.localSpeechAutoHint': 'Uses the MiMo voice first and falls back to local speech if MiMo fails.',
  'settings.localSpeechFirstHint': 'Uses browser-local speech first and tries the MiMo voice if local speech fails.',
  'settings.localSpeechDisabledHint': 'Uses only the MiMo voice and never falls back to local speech.',
  ...
  'settings.modelAutoPlayHintPreset': 'The selected audio format controls preset-voice playback.',
  ...
  'settings.formatPcmHint': 'Plays chunks as they arrive for a shorter wait; supports pause and resume. Falls back to MP3 if streaming fails before the first audio chunk.',
  'settings.formatMp3Hint': 'Plays after the complete file is generated. Smaller file size; supports pause and resume.',
  'settings.formatWavHint': 'Plays after the complete lossless file is generated. Larger file size; supports pause and resume.',
  ...
  'settings.voiceDesignPlaybackCompleteHint': 'Generates the entire reply before playback for better continuity.',
  'settings.voiceDesignPlaybackSegmentedHint': 'Generates and plays semantic segments in order; better for long text and faster start.',
  'settings.save': 'Save',
  ...
  'settings.uninstalled': 'Uninstalled. DSH remains active and will not load the plugin on its next start.',
