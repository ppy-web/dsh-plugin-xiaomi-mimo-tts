...
export const zh = {
  ...
  "settings.apiKeyConfigured": "个人配置",
  ...
  "settings.apiKeyUnsupportedSaved": "已保存密钥的格式未识别；请填写新密钥或清除个人配置。",
  "settings.apiKeyUnavailable": "暂时无法读取 Host 密钥状态，请检查连接后重试。",
  "settings.apiKeyPendingSave": "新密钥待保存；保存后才会用于 MiMo 试听。",
  "settings.apiKeyPendingClear": "保存后将清除个人密钥；如有基础配置，将恢复继承。",
  "settings.apiKeyClear": "清除个人密钥",
...
export const en: Record<keyof typeof zh, string> = {
  ...
  "settings.apiKeyConfigured": "Personal setting",
  ...
  "settings.apiKeyUnsupportedSaved":
    "The saved key format is not recognized. Enter a replacement or clear the personal setting.",
  ...
  "settings.apiKeyPendingClear":
    "Saving will clear the personal key. A base key will be inherited if one is configured.",
  "settings.apiKeyClear": "Clear personal key",
