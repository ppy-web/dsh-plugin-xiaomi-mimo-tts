...
function registerSlotContribution(
  ctx: Context,
  name: 'conversation.input.dock' | 'conversation.chat.assistant-actions' | 'plugins.item',
...
export function apply(ctx: Context): void {
  ...
  registerSlotContribution(ctx, 'plugins.item', () => ctx.slots.register({
    name: 'plugins.item',
    id: TTS_SETTINGS_NAMESPACE,
    order: 50,
