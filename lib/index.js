import { a as TTS_MODELS, c as TTS_STREAM_ROUTE, d as TTS_VOICE_DESIGN_PRESETS, g as prepareTtsText, i as TTS_FORMATS, n as DEFAULT_TTS_SETTINGS, o as TTS_ROUTE, s as TTS_SETTINGS_NAMESPACE, u as TTS_VOICE_DESIGN_ASSET_ROUTE } from "./shared-BZKSKG2B.js";
...
function apply(ctx, config) {
	...
	const voicePresetAssets = new Map(TTS_VOICE_DESIGN_PRESETS.map((preset) => {
		return [`${TTS_VOICE_DESIGN_ASSET_ROUTE}/${preset.id}.webp`, readFileSync(new URL(`../assets/voice-presets/${preset.id}.webp`, import.meta.url))];
	}));
	...
	ctx.effect(() => ctx.webServer.register({
		...
		handler(req, res) {
			...
			res.end(req.method === "HEAD" ? void 0 : asset);
		}
